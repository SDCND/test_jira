...
def courtCreation(frameLeft, frameRight):
    court = True
    ...
    grayImageLeft = cv2.cvtColor(tempImageLeft, cv2.COLOR_BGR2GRAY)
    grayImageRight = cv2.cvtColor(tempImageRight, cv2.COLOR_BGR2GRAY)
...
frameLeft = cv2.imread('testImages/LabSteroImage/frameLeftRGB0.jpg')
frameRight = cv2.imread('testImages/LabSteroImage/frameRightRGB0.jpg')
courtCreation(frameLeft, frameRight)